"""
Django settings for jewelcollector project.
...
SECRET_KEY = 'django-insecure-0tuorpio(=(-9knp-grh%@ibw-vl*h&o@31cscs--u=qp%gw6j'
...
ROOT_URLCONF = 'jewelcollector.urls'
...
WSGI_APPLICATION = 'jewelcollector.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        # 'USER': 'jewel_admin', <-- (optional) postgres user name, if you have to sign into an account to open psql, you will want to add that user name here.
